...
addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('keydown', e => {
    ...
    if (Input._source) {
      if (Input.isKey(e, ' ')) { e.preventDefault(); document.activeElement && document.activeElement.click(); return; }
      if (Input.isBack(e)) { e.preventDefault(); closeRenamePanel(false); return; }
      return;
    }
  ...
  document.addEventListener('keydown', e => {
    ...
    if (Input.isConfirm(e))      { e.preventDefault(); Pick.confirm(src); return; }
