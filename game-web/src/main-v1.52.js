...
addEventListener('DOMContentLoaded', () => {
  ...
  function renderGroups(list) {
    ...
    list.forEach(g => {
      ...
      b.innerHTML = `<span class="lg-left"><span class="lg-time">${formatCreatedAt(g.createdAt)}</span>`
        + `<span class="lg-name">${g.name}</span></span><span class="lg-count">${g.count} 人在線</span>`;
